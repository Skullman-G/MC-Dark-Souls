...
public abstract class PlayerCap<T extends PlayerEntity> extends LivingCap<T> implements EquipLoaded
{
	...
	public void onSave(CompoundNBT nbt)
	{
		...
		nbt.put("Attunements", this.attunements.save(new ListNBT()));
	...
	@Override
	public ExtendedDamageSource getDamageSource(Vector3d attackPos, int staminaDmgMul, StunType stunType, float amount, int requireddeflectionlevel, DamageType damageType, float poiseDamage)
	{
