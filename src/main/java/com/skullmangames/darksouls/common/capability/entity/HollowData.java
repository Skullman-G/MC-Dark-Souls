...
public class HollowData extends BipedMobData<HollowEntity>
{
	...
	public void setAIAsArmed()
	{
		...
		orgEntity.goalSelector.addGoal(0, new AttackPatternGoal(this, this.orgEntity, 0.0D, 1.75D, true, MobAttackPatterns.HOLLOW_LIGHT_PATTERN, MobAttackPatterns.HOLLOW_OTHER_PATTERN));
	}
