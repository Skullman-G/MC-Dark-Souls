...
public enum LivingMotion
{
	...
	FALL(10), HORSEBACK(11), DEATH(12), CHASING(13), SPELLCASTING(14), JUMPING(15), CELEBRATE(16), ADMIRE(17),
	NONE(18), AIMING(19), BLOCKING(20), RELOADING(21), SHOOTING(22), THROW_JAVELIN(23), EATING(24), DRINKING(25), CONSUME_SOUL(26), HOLDING_WEAPON(27, true),
