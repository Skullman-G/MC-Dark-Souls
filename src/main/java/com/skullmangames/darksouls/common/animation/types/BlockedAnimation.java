...
{
	public BlockedAnimation(ResourceLocation id, float convertTime, AnimFrameData frameData,
	...
	public static class Builder extends ActionAnimation.Builder
	{
		...
		{
			register.put(this.getId(), new BlockedAnimation(this.id, this.convertTime, this.getFrameData(),
