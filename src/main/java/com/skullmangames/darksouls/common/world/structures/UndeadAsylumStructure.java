...
public class UndeadAsylumStructure extends Structure<NoFeatureConfig>
{
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeSource, long seed, SharedSeedRandom chunkRandom, int chunkX, int chunkZ, Biome biome, ChunkPos chunkPos, NoFeatureConfig featureConfig)
	{
        ...
        IBlockReader zaWarudo = chunkGenerator.getBaseColumn(centerOfChunk.getX(), centerOfChunk.getZ());
        BlockState topBlock = zaWarudo.getBlockState(centerOfChunk.above(landHeight));
