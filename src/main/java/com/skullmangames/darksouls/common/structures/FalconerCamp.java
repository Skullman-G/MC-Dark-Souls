...
public class FalconerCamp extends StructureFeature<JigsawConfiguration>
{
	public FalconerCamp()
	{
		super(JigsawConfiguration.CODEC, FalconerCamp::createPiecesGenerator, PostPlacementProcessor.NONE);
	}
	...
	{
		if (!FalconerCamp.isFeatureChunk(context)) return Optional.empty();
