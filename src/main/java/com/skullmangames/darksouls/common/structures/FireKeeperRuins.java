...
public class FireKeeperRuins extends Structure<NoFeatureConfig>
{
	public FireKeeperRuins()
	{
	...
	{
		return FireKeeperRuins.Start::new;
	}
	...
	public static class Start extends StructureStart<NoFeatureConfig>
	{
				...
				int chunkZ, Biome biome, NoFeatureConfig config)
		{
			...
			ResourceLocation resourcelocation = new ResourceLocation(DarkSouls.MOD_ID, "fire_keeper_ruins/start_pool");
