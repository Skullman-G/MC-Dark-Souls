...
public class FireKeeperRuins extends StructureFeature<JigsawConfiguration>
{
	public FireKeeperRuins()
	{
		super(JigsawConfiguration.CODEC, FireKeeperRuins::createPiecesGenerator, PostPlacementProcessor.NONE);
	}
