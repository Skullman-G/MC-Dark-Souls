...
public final class Animations
{
	...
	public static final AttackArrayGetter BELL_GARGOYLE_LA = new AttackArrayGetter
			(
					DarkSouls.rl("bell_gargoyle_la_1"),
					DarkSouls.rl("bell_gargoyle_la_2"),
					DarkSouls.rl("bell_gargoyle_la_3")
			);
