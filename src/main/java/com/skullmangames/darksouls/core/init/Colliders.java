...
public class Colliders
{
	...
	public static final Collider SHORTSWORD = new CubeCollider(0.75F, 0.55F, 0.85F, 0F, 0F, -0.25F);
	public static final Collider LONGSWORD = new CubeCollider(0.75F, 0.65F, 0.85F, 0F, 0F, -0.25F);
	public static final Collider BROKEN_SWORD = new CubeCollider(0.45F, 0.25F, 0.45F, 0.0F, 0.0F, -0.25F);
	public static final Collider TOOL = new CubeCollider(0.4F, 0.4F, 0.55F, 0F, 0.0F, 0F);
	...
	public static final Collider SPEAR = new CubeCollider(0.4F, 0.4F, 0.9F, 0F, 0F, -1.35F);
	public static final Collider ULTRA_GREATSWORD = new CubeCollider(0.4F, 0.4F, 0.9F, 0F, 0F, -1.35F);
	
	
	//Asylum Demon
	public static final Collider STRAY_DEMON_GREAT_HAMMER = GREAT_HAMMER.getScaledCollider(StrayDemonCap.getWeaponScale());
	public static final Collider ASYLUM_DEMON_BODY = new CubeCollider(3F, 1F, 3F, 0F, 0F, 0F);
}