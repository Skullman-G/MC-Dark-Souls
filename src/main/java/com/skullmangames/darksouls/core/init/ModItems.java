...
public class ModItems
{
	...
	//Hammers
	public static final RegistryObject<Item> MACE = ITEMS.register("mace", () -> new SwordItem(ItemTier.IRON, 4, -2.4F, new Item.Properties()
			.tab(DarkSouls.TAB)));
	...
	//Ultra Greatsword
	public static final RegistryObject<Item> ZWEIHANDER = ITEMS.register("zweihander", () -> new SwordItem(ItemTier.IRON, 8, -2.4F, new Item.Properties()
			.tab(DarkSouls.TAB)));
	...
	public static final RegistryObject<Item> ELITE_CLERIC_HELM = ITEMS.register("elite_cleric_helm", () -> new ModArmorItem(ArmorMaterial.IRON, EquipmentSlotType.HEAD, "elite_cleric_set_layer_1", new Item.Properties()
			.tab(DarkSouls.TAB)));
	public static final RegistryObject<Item> ELITE_CLERIC_ARMOR = ITEMS.register("elite_cleric_armor", () -> new ModArmorItem(ArmorMaterial.IRON, EquipmentSlotType.CHEST, "elite_cleric_set_layer_1", new Item.Properties()
			.tab(DarkSouls.TAB)));
	public static final RegistryObject<Item> ELITE_CLERIC_LEGGINGS = ITEMS.register("elite_cleric_leggings", () -> new ModArmorItem(ArmorMaterial.IRON, EquipmentSlotType.LEGS, "elite_cleric_set_layer_1", new Item.Properties()
			.tab(DarkSouls.TAB)));
	
	public static final RegistryObject<Item> FALCONER_HELM = ITEMS.register("falconer_helm", () -> new ModArmorItem(ArmorMaterial.IRON, EquipmentSlotType.HEAD, "falconer_set_layer_1", new Item.Properties()
			.tab(DarkSouls.TAB)));
	public static final RegistryObject<Item> FALCONER_ARMOR = ITEMS.register("falconer_armor", () -> new ModArmorItem(ArmorMaterial.IRON, EquipmentSlotType.CHEST, "falconer_set_layer_1", new Item.Properties()
			.tab(DarkSouls.TAB)));
	public static final RegistryObject<Item> FALCONER_LEGGINGS = ITEMS.register("falconer_leggings", () -> new ModArmorItem(ArmorMaterial.IRON, EquipmentSlotType.LEGS, "falconer_set_layer_1", new Item.Properties()
			.tab(DarkSouls.TAB)));
	public static final RegistryObject<Item> FALCONER_BOOTS = ITEMS.register("falconer_boots", () -> new ModArmorItem(ArmorMaterial.IRON, EquipmentSlotType.FEET, "falconer_set_layer_2", new Item.Properties()
			.tab(DarkSouls.TAB)));
