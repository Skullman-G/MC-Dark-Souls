...
public abstract class Models<T extends Model>
{
	...
	protected abstract T register(String name, Armature armature);
	...
	public static class ServerModels extends Models<Model>
	{
		public ServerModels()
		{
			...
			this.ENTITY_BIPED_64_32_TEX = this.register("biped", ENTITY_BIPED.getArmature());
		...
		@Override
		protected Model register(String name, Armature armature)
		{
			Model model = new Model(new ResourceLocation(DarkSouls.MOD_ID, name));
