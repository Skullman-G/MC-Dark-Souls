...
public class DSFolderPackResources extends AbstractDSPackResources
{
	private static final Logger LOGGER = LogUtils.getLogger();
	private static final boolean ON_WINDOWS = Util.getPlatform() == Util.OS.WINDOWS;
	private static final CharMatcher BACKSLASH_MATCHER = CharMatcher.is('\\');

	public DSFolderPackResources(File p_10257_)
	{
		super(p_10257_);
	}
	...
	public Set<String> getNamespaces(@Nullable PackType p_10259_)
	{
		Set<String> set = Sets.newHashSet();
		File file1 = new File(this.file, DSDefaultPackResources.ROOT_DIR_NAME);
	...
	public Collection<ResourceLocation> getResources(@Nullable PackType p_10261_, String p_10262_, String p_10263_, int p_10264_,
			Predicate<String> p_10265_)
	{
		File file1 = new File(this.file, DSDefaultPackResources.ROOT_DIR_NAME);
		List<ResourceLocation> list = Lists.newArrayList();
		this.listResources(new File(new File(file1, p_10262_), p_10263_), p_10264_, p_10262_, list, p_10263_ + "/",
				p_10265_);
		return list;
	}

	private void listResources(File p_10267_, int p_10268_, String p_10269_, List<ResourceLocation> p_10270_,
			String p_10271_, Predicate<String> p_10272_)
	{
		...
		if (afile != null)
		{
			for (File file1 : afile)
			{
				if (file1.isDirectory())
				{
					if (p_10268_ > 0)
					{
						this.listResources(file1, p_10268_ - 1, p_10269_, p_10270_, p_10271_ + file1.getName() + "/",
								p_10272_);
					}
