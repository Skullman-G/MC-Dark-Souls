...
public abstract class AbstractDSPackResources implements PackResources
{
	private static final Logger LOGGER = LogUtils.getLogger();
	public final File file;

	public AbstractDSPackResources(File p_10207_)
	{
		this.file = p_10207_;
	}

	private static String getPathFromLocation(ResourceLocation p_10228_)
	{
		return String.format("%s/%s/%s", DSDefaultPackResources.ROOT_DIR_NAME, p_10228_.getNamespace(), p_10228_.getPath());
	}
	...
	public InputStream getResource(@Nullable PackType p_10210_, ResourceLocation p_10211_) throws IOException
	{
		return this.getResource(getPathFromLocation(p_10211_));
	}

	public boolean hasResource(@Nullable PackType p_10222_, ResourceLocation p_10223_)
	{
		return this.hasResource(getPathFromLocation(p_10223_));
	}
