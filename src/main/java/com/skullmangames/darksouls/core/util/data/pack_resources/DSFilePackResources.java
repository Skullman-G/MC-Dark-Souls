...
public class DSFilePackResources extends AbstractDSPackResources
{
	public static final Splitter SPLITTER = Splitter.on('/').omitEmptyStrings().limit(3);
	@Nullable
	private ZipFile zipFile;

	public DSFilePackResources(File p_10236_)
	{
		super(p_10236_);
	}
	...
	public Set<String> getNamespaces(@Nullable PackType p_10238_)
	{
		ZipFile zipfile;
		try
		{
		...
		while (enumeration.hasMoreElements())
		{
			...
			if (s.startsWith(DSDefaultPackResources.ROOT_DIR_NAME + "/"))
			{
	...
	public Collection<ResourceLocation> getResources(@Nullable PackType p_10240_, String p_10241_, String p_10242_, int p_10243_,
			Predicate<String> p_10244_)
	{
		ZipFile zipfile;
		try
		{
		...
		String s = DSDefaultPackResources.ROOT_DIR_NAME + "/" + p_10241_ + "/";
