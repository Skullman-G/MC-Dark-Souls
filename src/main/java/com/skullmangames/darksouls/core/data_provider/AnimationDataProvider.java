...
public class AnimationDataProvider implements DataProvider
{
	...
	private static List<AnimBuilder> defaultConfigs()
	{
		...
		(
				new StaticAnimation.Builder(Animations.BIPED_IDLE.getId(), 0.1F, true, DarkSouls.rl("biped/living/idle"),
				...
				new MovementAnimation.Builder(Animations.BIPED_RUN.getId(), 0.08F, true, DarkSouls.rl("biped/living/run"),
						(models) -> models.ENTITY_BIPED),
				...
				new DeathAnimation.Builder(Animations.BIPED_DEATH_SMASH.getId(), 0.05F, DarkSouls.rl("biped/death/smash"),
				...
				new StaticAnimation.Builder(Animations.BIPED_DIG.getId(), 0.2F, true,
				...
				new MirrorAnimation.Builder(Animations.BIPED_EAT.getId(), 0.2F, true, DarkSouls.rl("biped/living/eat_r"),
				...
				// Blocks
				new AdaptableAnimation.Builder(Animations.BIPED_BLOCK_HORIZONTAL.getId(), 0.1F, true, (models) -> models.ENTITY_BIPED)
				...
				new ActionAnimation.Builder(Animations.BIPED_HIT_LIGHT_FRONT.getId(), 0.05F, DarkSouls.rl("biped/hit/light_front"),
				...
				new ActionAnimation.Builder(Animations.BIPED_HIT_LIGHT_LEFT.getId(), 0.05F, DarkSouls.rl("biped/hit/light_left"),
						(models) -> models.ENTITY_BIPED).addProperty(ActionAnimationProperty.ALLOW_MIX_LAYERS, true)
						.addProperty(ActionAnimationProperty.IS_HIT, true),
				new ActionAnimation.Builder(Animations.BIPED_HIT_LIGHT_RIGHT.getId(), 0.05F, DarkSouls.rl("biped/hit/light_right"),
						(models) -> models.ENTITY_BIPED).addProperty(ActionAnimationProperty.ALLOW_MIX_LAYERS, true)
						.addProperty(ActionAnimationProperty.IS_HIT, true),
				new ActionAnimation.Builder(Animations.BIPED_HIT_LIGHT_BACK.getId(), 0.05F, DarkSouls.rl("biped/hit/light_back"),
						(models) -> models.ENTITY_BIPED).addProperty(ActionAnimationProperty.ALLOW_MIX_LAYERS, true)
						.addProperty(ActionAnimationProperty.IS_HIT, true),
				new ActionAnimation.Builder(Animations.BIPED_HIT_HEAVY_FRONT.getId(), 0.05F, DarkSouls.rl("biped/hit/heavy_front"),
						(models) -> models.ENTITY_BIPED).addProperty(ActionAnimationProperty.ALLOW_MIX_LAYERS, true)
						.addProperty(ActionAnimationProperty.IS_HIT, true),
				new ActionAnimation.Builder(Animations.BIPED_HIT_HEAVY_BACK.getId(), 0.05F, DarkSouls.rl("biped/hit/heavy_back"),
						(models) -> models.ENTITY_BIPED).addProperty(ActionAnimationProperty.ALLOW_MIX_LAYERS, true)
						.addProperty(ActionAnimationProperty.IS_HIT, true),
				new ActionAnimation.Builder(Animations.BIPED_HIT_HEAVY_LEFT.getId(), 0.05F, DarkSouls.rl("biped/hit/heavy_left"),
						(models) -> models.ENTITY_BIPED).addProperty(ActionAnimationProperty.ALLOW_MIX_LAYERS, true)
						.addProperty(ActionAnimationProperty.IS_HIT, true),
				new ActionAnimation.Builder(Animations.BIPED_HIT_HEAVY_RIGHT.getId(), 0.05F, DarkSouls.rl("biped/hit/heavy_right"),
						(models) -> models.ENTITY_BIPED).addProperty(ActionAnimationProperty.ALLOW_MIX_LAYERS, true)
						.addProperty(ActionAnimationProperty.IS_HIT, true),
				...
				new InvincibleAnimation.Builder(Animations.BIPED_HIT_SMASH.getId(), 0.05F, DarkSouls.rl("biped/hit/smash"),
						(models) -> models.ENTITY_BIPED),
				...
				new InvincibleAnimation.Builder(Animations.BIPED_HIT_FLY_RIGHT.getId(), 0.05F,
						DarkSouls.rl("biped/hit/fly_right"), (models) -> models.ENTITY_BIPED)
								...
								{ new PlaySoundEvent(0.48F, Side.SERVER, ModSoundEvents.GENERIC_LAND),
										new PlaySoundEvent(0.92F, Side.SERVER, ModSoundEvents.GENERIC_LAND) }),
				new ActionAnimation.Builder(Animations.BIPED_HIT_LAND_HEAVY.getId(), 0.05F, DarkSouls.rl("biped/hit/land_heavy"),
				...
				new DodgingAnimation.Builder(Animations.BIPED_ROLL_BACK.getId(), 0.05F, DarkSouls.rl("biped/combat/roll_back"),
						(models) -> models.ENTITY_BIPED).addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
				...
				new DodgingAnimation.Builder(Animations.BIPED_ROLL_RIGHT.getId(), 0.05F, true,
						DarkSouls.rl("biped/combat/roll_right"), (models) -> models.ENTITY_BIPED)
								.addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
								{ new PlaySoundEvent(0.28F, Side.SERVER, ModSoundEvents.GENERIC_ROLL) }),
				new DodgingAnimation.Builder(Animations.BIPED_JUMP_BACK.getId(), 0.08F, DarkSouls.rl("biped/combat/jump_back"),
						(models) -> models.ENTITY_BIPED),
				...
				// Backstabs
				new BackstabCheckAnimation.Builder(Animations.BACKSTAB_THRUST.getId(), AttackType.BACKSTAB, 0.2F,
				...
				new BackstabCheckAnimation.Builder(Animations.BACKSTAB_STRIKE.getId(), AttackType.BACKSTAB, 0.2F,
				...
				// Punishes
				new PunishCheckAnimation.Builder(Animations.PUNISH_THRUST.getId(), AttackType.PUNISH, 0.2F, 0.0F,
				...
				new InvincibleAnimation.Builder(DarkSouls.rl("punish_thrust_followup"), 0.05F,
						DarkSouls.rl("biped/combat/backstab_thrust"), (models) -> models.ENTITY_BIPED)
								...
								{ new PlaySoundEvent(AnimEvent.ON_BEGIN, Side.SERVER,
										...
										new PlaySoundEvent(1.08F, Side.SERVER, ModSoundEvents.SWORD_PULLOUT),
										new ShakeCamEvent(1.3F, 10, 0.5F) }),
				new PunishCheckAnimation.Builder(Animations.PUNISH_STRIKE.getId(), AttackType.PUNISH, 0.2F, 0.0F,
				...
				// Thrusting Sword
				new AttackAnimation.Builder(Animations.THRUSTING_SWORD_LIGHT_ATTACK.getId(), AttackType.LIGHT, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.THRUSTING_SWORD_TH_HEAVY_ATTACK.getIds()[0], AttackType.HEAVY, 0.2F,
				...
				{ new PlaySoundEvent(0.72F, Side.SERVER, ModSoundEvents.SWORD_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 25)
								.addProperty(AttackProperty.POISE_DAMAGE, 15),
				new AttackAnimation.Builder(Animations.THRUSTING_SWORD_TH_HEAVY_ATTACK.getIds()[1], AttackType.HEAVY, 0.2F,
				...
				new AttackAnimation.Builder(Animations.THRUSTING_SWORD_TH_DASH_ATTACK.getId(), AttackType.DASH, 0.2F, 0.0F,
				...
				// Greatsword
				new AttackAnimation.Builder(Animations.GREATSWORD_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.3F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.GREATSWORD_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.3F, 0.0F,
				...
				{ new PlaySoundEvent(0.64F, Side.SERVER, ModSoundEvents.SWORD_THRUST) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 35)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.GREATSWORD_DASH_ATTACK.getId(), AttackType.DASH, 0.1F, 0.0F, 0.48F,
				...
				new AttackAnimation.Builder(Animations.GREATSWORD_TH_LIGHT_ATTACK.getIds()[0], AttackType.TWO_HANDED_LIGHT, 0.5F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.GREATSWORD_TH_LIGHT_ATTACK.getIds()[1], AttackType.TWO_HANDED_LIGHT, 0.3F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.GREATSWORD_TH_THRUST_ATTACK.getIds()[0], AttackType.TWO_HANDED_HEAVY, 0.5F, 0.0F,
				...
				{ new PlaySoundEvent(0.4F, Side.SERVER, ModSoundEvents.SWORD_THRUST) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 35)
								.addProperty(AttackProperty.POISE_DAMAGE, 26),
				new AttackAnimation.Builder(Animations.GREATSWORD_TH_THRUST_ATTACK.getIds()[1], AttackType.TWO_HANDED_HEAVY, 0.3F, 0.0F,
						0.28F, 0.48F, 2.0F, "Tool_R", DarkSouls.rl("biped/combat/greatsword_th_la_2"),
						(models) -> models.ENTITY_BIPED).addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
				{ new PlaySoundEvent(0.28F, Side.SERVER, ModSoundEvents.SWORD_SWING) })
								.addProperty(AttackProperty.MOVEMENT_DAMAGE_TYPE, MovementDamageType.REGULAR)
				...
				new AttackAnimation.Builder(Animations.GREATSWORD_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.05F, 0.0F,
						0.4F, 0.52F, 1.6F, "Tool_R", DarkSouls.rl("biped/combat/greatsword_th_ha_1"),
						(models) -> models.ENTITY_BIPED).addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
				{ new PlaySoundEvent(0.4F, Side.SERVER, ModSoundEvents.SWORD_THRUST) })
								.addProperty(AttackProperty.MOVEMENT_DAMAGE_TYPE, MovementDamageType.REGULAR)
				...
				// Ultra Greatsword
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.3F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.2F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_HEAVY_ATTACK.getIds()[0], AttackType.HEAVY, 0.5F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_HEAVY_ATTACK.getIds()[1], AttackType.HEAVY, 0.5F,
						0.0F, 1.35F, 1.6F, 3.45F, "Tool_R",
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_DASH_ATTACK.getId(), AttackType.DASH, 0.1F, 0.0F, 0.68F, 0.96F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_TH_LIGHT_ATTACK.getIds()[0], AttackType.TWO_HANDED_LIGHT, 0.3F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_TH_LIGHT_ATTACK.getIds()[1], AttackType.TWO_HANDED_LIGHT, 0.2F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_TH_HEAVY_ATTACK.getIds()[0], AttackType.TWO_HANDED_HEAVY, 0.5F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_TH_HEAVY_ATTACK.getIds()[1], AttackType.TWO_HANDED_HEAVY, 0.5F,
				...
				new AttackAnimation.Builder(Animations.ULTRA_GREATSWORD_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.1F,
						0.0F, 1.35F, 1.6F, 3.45F, "Tool_R", DarkSouls.rl("biped/combat/ultra_greatsword_th_ha_1"),
						(models) -> models.ENTITY_BIPED)
								.addProperty(StaticAnimationProperty.EVENTS,
				...
				// Greataxe
				new AttackAnimation.Builder(Animations.GREATAXE_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.3F, 0.0F, 0.64F, 0.92F,
				...
				new AttackAnimation.Builder(Animations.GREATAXE_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.3F, 0.0F, 0.76F, 1.0F,
				...
				new AttackAnimation.Builder(Animations.GREATAXE_HEAVY_ATTACK.getId(), AttackType.HEAVY, 0.3F, 0.0F, 1.08F, 1.28F,
						2.2F, "Tool_R", DarkSouls.rl("biped/combat/greataxe_ha"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 30),
				new AttackAnimation.Builder(Animations.GREATAXE_DASH_ATTACK.getId(), AttackType.DASH, 0.1F, 0.0F, 0.68F, 0.96F,
				...
				new AttackAnimation.Builder(Animations.GREATAXE_TH_LIGHT_ATTACK.getIds()[0], AttackType.TWO_HANDED_LIGHT, 0.3F, 0.0F,
						...
						(models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 30)
								.addProperty(AttackProperty.POISE_DAMAGE, 30),
				new AttackAnimation.Builder(Animations.GREATAXE_TH_LIGHT_ATTACK.getIds()[1], AttackType.TWO_HANDED_LIGHT, 0.3F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.GREATAXE_TH_HEAVY_ATTACK.getId(), AttackType.TWO_HANDED_HEAVY, 0.3F, 0.0F,
						...
						(models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 30),
				new AttackAnimation.Builder(Animations.GREATAXE_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.1F, 0.0F,
				...
				// Spear
				new AttackAnimation.Builder(Animations.SPEAR_DASH_ATTACK.getId(), AttackType.DASH, 0.2F, 0.0F, 0.4F, 0.52F,
				...
				{ new PlaySoundEvent(0.32F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 15)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.SPEAR_LIGHT_BLOCKING_ATTACK.getId(), AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.35F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 15)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.SPEAR_TH_LIGHT_ATTACK.getId(), AttackType.TWO_HANDED_LIGHT, 0.15F, 0.0F, 0.4F,
				...
				{ new PlaySoundEvent(0.4F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 15)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.SPEAR_TH_HEAVY_ATTACK.getId(), AttackType.TWO_HANDED_HEAVY, 0.35F, 0.0F, 0.6F,
						0.8F, 1.6F, "Tool_R", DarkSouls.rl("biped/combat/spear_th_ha"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 25)
								.addProperty(AttackProperty.POISE_DAMAGE, 26),
				new AttackAnimation.Builder(Animations.SPEAR_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.2F, 0.0F, 0.36F,
				...
				new AttackAnimation.Builder(Animations.DAGGER_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F, 0.16F,
						...
						(models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.DEFLECTION, Deflection.LIGHT),
				new AttackAnimation.Builder(Animations.DAGGER_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F, 0.04F,
				...
				new AttackAnimation.Builder(Animations.GREAT_HAMMER_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.5F, 0.0F,
						...
						(models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 30)
								.addProperty(AttackProperty.POISE_DAMAGE, 28),
				new AttackAnimation.Builder(Animations.GREAT_HAMMER_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.5F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.GREAT_HAMMER_DASH_ATTACK.getId(), AttackType.DASH, 0.1F, 0.0F, 0.68F, 0.96F,
						2.0F, "Tool_R", DarkSouls.rl("biped/combat/greataxe_da"),
						(models) -> models.ENTITY_BIPED)
								.addProperty(StaticAnimationProperty.EVENTS,
										SmashEvents.BIG_HAMMER.appendTo(0.93F, new AnimEvent[]
				...
				new AttackAnimation.Builder(Animations.GREAT_HAMMER_TH_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.5F, 0.0F, 0.32F,
						...
						(models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 30)
								.addProperty(AttackProperty.POISE_DAMAGE, 36),
				new AttackAnimation.Builder(Animations.GREAT_HAMMER_TH_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.5F, 0.0F, 0.24F,
				...
				new AttackAnimation.Builder(Animations.GREAT_HAMMER_TH_HEAVY_ATTACK.getId(), AttackType.HEAVY, 0.5F, 0.0F, 0.32F,
				...
				new AttackAnimation.Builder(Animations.GREAT_HAMMER_TH_DASH_ATTACK.getId(), AttackType.LIGHT, 0.5F, 0.0F, 0.32F,
						0.56F, 1.6F, "Tool_R", DarkSouls.rl("biped/combat/great_hammer_th_la_1"),
						(models) -> models.ENTITY_BIPED)
								.addProperty(StaticAnimationProperty.EVENTS,
										SmashEvents.BIG_HAMMER.appendTo(0.56F, new AnimEvent[]
				...
				// Axe
				new AttackAnimation.Builder(Animations.AXE_HEAVY_ATTACK.getId(), AttackType.HEAVY, 0.3F, 0.0F, 0.55F, 0.7F,
				...
				{ new PlaySoundEvent(0.16F, Side.SERVER, ModSoundEvents.AXE_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 20)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.AXE_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F, 0.15F,
				...
				new AttackAnimation.Builder(Animations.AXE_TH_LIGHT_ATTACK.getIds()[0], AttackType.TWO_HANDED_LIGHT, 0.4F, 0.0F, 0.08F,
						0.4F, 1.2F, "Tool_R", DarkSouls.rl("biped/combat/axe_th_la_1"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 20)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.AXE_TH_LIGHT_ATTACK.getIds()[1], AttackType.TWO_HANDED_LIGHT, 0.4F, 0.0F, 0.08F,
				...
				new AttackAnimation.Builder(Animations.AXE_TH_HEAVY_ATTACK.getId(), AttackType.TWO_HANDED_HEAVY, 0.4F, 0.0F, 0.32F,
						0.56F, 1.6F, "Tool_R", DarkSouls.rl("biped/combat/axe_th_ha"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 30)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.AXE_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.1F, 0.0F, 0.48F,
				...
				// Hammer
				new AttackAnimation.Builder(Animations.HAMMER_DASH_ATTACK.getId(), AttackType.DASH, 0.2F, 0.0F, 0.4F, 0.6F,
				...
				{ new PlaySoundEvent(0.28F, Side.SERVER, ModSoundEvents.AXE_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 20)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.HAMMER_TH_LIGHT_ATTACK.getId(), AttackType.TWO_HANDED_LIGHT, 0.3F, 0.0F,
				...
				{ new PlaySoundEvent(0.2F, Side.SERVER, ModSoundEvents.AXE_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 20)
								.addProperty(AttackProperty.POISE_DAMAGE, 32),
				new AttackAnimation.Builder(Animations.HAMMER_TH_HEAVY_ATTACK.getId(), AttackType.TWO_HANDED_HEAVY, 0.4F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.HAMMER_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.2F, 0.0F, 0.24F,
				...
				// Fist
				new AttackAnimation.Builder(Animations.FIST_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F, 0.3F,
				...
				{ new PlaySoundEvent(0.3F, Side.SERVER, ModSoundEvents.FIST_SWING) })
								...
								.addProperty(AttackProperty.POISE_DAMAGE, 15),
				new AttackAnimation.Builder(Animations.FIST_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F, 0.15F,
				...
				new AttackAnimation.Builder(Animations.FIST_DASH_ATTACK.getId(), AttackType.DASH, 0.3F, 0.0F, 0.15F, 0.3F,
				...
				// Shield
				new AttackAnimation.Builder(Animations.SHIELD_LIGHT_ATTACK.getId(), AttackType.LIGHT, 0.2F, 0.0F, 0.4F, 0.56F, 1.2F,
				...
				new AttackAnimation.Builder(Animations.SHIELD_HEAVY_ATTACK.getIds()[0], AttackType.HEAVY, 0.2F, 0.0F, 0.44F, 0.56F,
						1.4F, "Tool_R", DarkSouls.rl("biped/combat/shield_ha_1"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.SHIELD_HEAVY_ATTACK.getIds()[1], AttackType.HEAVY, 0.2F, 0.0F, 0.28F, 0.48F,
				...
				new AttackAnimation.Builder(Animations.SHIELD_DASH_ATTACK.getId(), AttackType.DASH, 0.05F, 0.0F, 0.32F, 0.52F, 1.4F,
						"Tool_R", DarkSouls.rl("biped/combat/shield_da"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 25)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.SHIELD_TH_LIGHT_ATTACK.getId(), AttackType.TWO_HANDED_LIGHT, 0.3F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.SHIELD_TH_HEAVY_ATTACK.getIds()[0], AttackType.TWO_HANDED_HEAVY, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.28F, Side.SERVER, ModSoundEvents.FIST_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 30)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.SHIELD_TH_HEAVY_ATTACK.getIds()[1], AttackType.TWO_HANDED_HEAVY, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.SHIELD_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.2F, 0.0F, 0.12F,
				...
				// Straight Sword
				new AttackAnimation.Builder(Animations.STRAIGHT_SWORD_LIGHT_ATTACK.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.24F, Side.SERVER, ModSoundEvents.SWORD_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 15)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.STRAIGHT_SWORD_LIGHT_ATTACK.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.STRAIGHT_SWORD_HEAVY_ATTACK.getId(), AttackType.HEAVY, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.STRAIGHT_SWORD_TH_LIGHT_ATTACK.getIds()[0], AttackType.TWO_HANDED_LIGHT, 0.1F,
				...
				{ new PlaySoundEvent(0.36F, Side.SERVER, ModSoundEvents.SWORD_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 15)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.STRAIGHT_SWORD_TH_LIGHT_ATTACK.getIds()[1], AttackType.TWO_HANDED_LIGHT, 0.1F,
				...
				new AttackAnimation.Builder(Animations.STRAIGHT_SWORD_TH_HEAVY_ATTACK.getId(), AttackType.TWO_HANDED_HEAVY, 0.2F,
				...
				{ new PlaySoundEvent(0.36F, Side.SERVER, ModSoundEvents.SWORD_THRUST) })
								...
								.addProperty(AttackProperty.STAMINA_USAGE, 25)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.STRAIGHT_SWORD_TH_DASH_ATTACK.getId(), AttackType.TWO_HANDED_DASH, 0.2F,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LIGHT_ATTACKS.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F, 0.56F,
						1.05F, 2.5F, "Tool_R", DarkSouls.rl("hollow/swing_1"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 44)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_LIGHT_ATTACKS.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F, 0.48F,
						1.0F, 2.0F, "Tool_R", DarkSouls.rl("hollow/swing_2"), (models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 44)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_LIGHT_ATTACKS.getIds()[2], AttackType.LIGHT, 0.2F, 0.0F, 0.16F,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_BARRAGE.getId(), AttackType.LIGHT, 0.2F,
						...
						new Phase(2.88F, 3.08F, 3.2F, 4.2F, "Tool_R", Colliders.BROKEN_SWORD))
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 44)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_OVERHEAD_SWING.getId(), AttackType.HEAVY, 0.2F, 0.0F, 0.4F,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_WARRIOR_DASH_ATTACK.getId(), AttackType.DASH, 0.2F,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_WARRIOR_AXE_LA.getIds()[0], AttackType.LIGHT, 0.2F,
				...
				{ new PlaySoundEvent(0.6F, Side.SERVER, ModSoundEvents.AXE_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 50)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_WARRIOR_AXE_LA.getIds()[1], AttackType.LIGHT, 0.2F,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_WARRIOR_AXE_TH_LA.getIds()[0], AttackType.LIGHT, 0.2F,
				...
				{ new PlaySoundEvent(0.56F, Side.SERVER, ModSoundEvents.AXE_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 50)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_WARRIOR_AXE_TH_LA.getIds()[1], AttackType.LIGHT, 0.2F,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SWORD_LA.getIds()[0], AttackType.LIGHT, 0.2F,
				...
				{ new PlaySoundEvent(0.44F, Side.SERVER, ModSoundEvents.SWORD_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 50)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SWORD_LA.getIds()[1], AttackType.LIGHT, 0.2F,
				...
				{ new PlaySoundEvent(0.16F, Side.SERVER, ModSoundEvents.SWORD_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 50)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SWORD_LA.getIds()[2], AttackType.LIGHT, 0.2F,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SWORD_HEAVY_THRUST.getId(), AttackType.HEAVY,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SWORD_THRUST_COMBO.getId(), AttackType.LIGHT,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SPEAR_SWINGS.getIds()[0], AttackType.LIGHT,
				...
				{ new PlaySoundEvent(0.48F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SPEAR_SWINGS.getIds()[1], AttackType.LIGHT,
				...
				{ new PlaySoundEvent(0.16F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SPEAR_SWINGS.getIds()[2], AttackType.LIGHT,
				...
				{ new PlaySoundEvent(0.6F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SPEAR_SWINGS.getIds()[3], AttackType.LIGHT,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SPEAR_THRUSTS.getIds()[0], AttackType.LIGHT,
				...
				{ new PlaySoundEvent(0.64F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SPEAR_THRUSTS.getIds()[1], AttackType.LIGHT,
				...
				{ new PlaySoundEvent(0.72F, Side.SERVER, ModSoundEvents.SPEAR_SWING) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SPEAR_THRUSTS.getIds()[2], AttackType.LIGHT,
				...
				new AttackAnimation.Builder(Animations.HOLLOW_LORDRAN_SOLDIER_SHIELD_BASH.getId(), AttackType.HEAVY, 0.2F,
				...
				new AttackAnimation.Builder(Animations.BALDER_KNIGHT_SIDE_SWORD_LA.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.4F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						...
						new PlaySoundEvent(1.6F, Side.CLIENT, ModSoundEvents.BALDER_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 44)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.BALDER_KNIGHT_SIDE_SWORD_LA.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.16F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						...
						new PlaySoundEvent(1.6F, Side.CLIENT, ModSoundEvents.BALDER_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 44)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.BALDER_KNIGHT_SIDE_SWORD_LA.getIds()[2], AttackType.LIGHT, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BALDER_KNIGHT_SIDE_SWORD_HA.getId(), AttackType.HEAVY, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BALDER_KNIGHT_RAPIER_LA.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.4F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						...
						new PlaySoundEvent(1.16F, Side.CLIENT, ModSoundEvents.BALDER_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 37)
								.addProperty(AttackProperty.POISE_DAMAGE, 15),
				new AttackAnimation.Builder(Animations.BALDER_KNIGHT_RAPIER_LA.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.24F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						...
						new PlaySoundEvent(1.16F, Side.CLIENT, ModSoundEvents.BALDER_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 37)
								.addProperty(AttackProperty.POISE_DAMAGE, 15),
				new AttackAnimation.Builder(Animations.BALDER_KNIGHT_RAPIER_LA.getIds()[2], AttackType.LIGHT, 0.1F, 0.0F,
						0.24F, 0.44F, 1.2F, "Tool_R", DarkSouls.rl("balder_knight/rapier_la_2"),
						(models) -> models.ENTITY_BIPED).addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
				{ new PlaySoundEvent(0.24F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						new PlaySoundEvent(0.32F, Side.CLIENT, ModSoundEvents.BALDER_KNIGHT_FOOT),
				...
				new AttackAnimation.Builder(Animations.BERENIKE_KNIGHT_SWORD_LA.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(1.04F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						...
						new PlaySoundEvent(2.36F, Side.CLIENT, ModSoundEvents.BERENIKE_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 75)
								.addProperty(AttackProperty.POISE_DAMAGE, 32),
				new AttackAnimation.Builder(Animations.BERENIKE_KNIGHT_SWORD_LA.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BERENIKE_KNIGHT_SWORD_HA.getIds()[0], AttackType.HEAVY, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BERENIKE_KNIGHT_SWORD_HA.getIds()[1], AttackType.HEAVY, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BERENIKE_KNIGHT_MACE_LA.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F,
						...
						(models) -> models.ENTITY_BIPED)
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 75)
								.addProperty(AttackProperty.POISE_DAMAGE, 32),
				new AttackAnimation.Builder(Animations.BERENIKE_KNIGHT_MACE_LA.getIds()[1], AttackType.LIGHT, 0.2F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BERENIKE_KNIGHT_KICK.getId(), AttackType.HEAVY, 0.2F, 0.0F, 0.56F,
				...
				new DeathAnimation.Builder(Animations.BLACK_KNIGHT_DEATH.getId(), 0.1F, DarkSouls.rl("black_knight/death"),
						(models) -> models.ENTITY_BIPED).addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
				{ new PlaySoundEvent(1.84F, Side.SERVER, ModSoundEvents.GENERIC_LAND), })
								.addProperty(DeathProperty.DISAPPEAR_AT, 0.5F),

				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_LA_LONG.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F,
				...
				{ new PlaySoundEvent(0.48F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT),
						...
						new PlaySoundEvent(1.28F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 56)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_LA_LONG.getIds()[1], AttackType.LIGHT, 0.1F, 0.0F,
				...
				{ new PlaySoundEvent(0.44F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						...
						new PlaySoundEvent(1.28F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 56)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_LA_LONG.getIds()[2], AttackType.HEAVY, 0.1F, 0.0F,
				...
				{ new PlaySoundEvent(0.2F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT),
						...
						new PlaySoundEvent(1.48F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 56)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_LA_LONG.getIds()[3], AttackType.HEAVY, 0.1F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_LA_SHORT.getIds()[0], AttackType.LIGHT, 0.2F, 0.0F,
						0.56F, 0.8F, 1.4F, "Tool_R", DarkSouls.rl("black_knight/black_knight_sword_la_1"),
						(models) -> models.ENTITY_BIPED).addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
				{ new PlaySoundEvent(0.48F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT),
						new PlaySoundEvent(0.56F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						new PlaySoundEvent(1.28F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 56)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_LA_SHORT.getIds()[1], AttackType.LIGHT, 0.1F, 0.0F,
						0.44F, 0.64F, 1.4F, "Tool_R", DarkSouls.rl("black_knight/black_knight_sword_la_2"),
						(models) -> models.ENTITY_BIPED).addProperty(StaticAnimationProperty.EVENTS, new AnimEvent[]
				{ new PlaySoundEvent(0.44F, Side.CLIENT, ModSoundEvents.SWORD_SWING),
						new PlaySoundEvent(0.48F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT),
						new PlaySoundEvent(1.28F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 56)
								.addProperty(AttackProperty.POISE_DAMAGE, 23),
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_LA_SHORT.getIds()[2], AttackType.HEAVY, 0.1F, 0.0F,
				...
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_HA.getId(), AttackType.HEAVY, 0.2F, 0.0F, 0.4F,
				...
				{ new PlaySoundEvent(0.52F, Side.CLIENT, ModSoundEvents.AXE_SWING),
						...
						new PlaySoundEvent(1.52F, Side.CLIENT, ModSoundEvents.BLACK_KNIGHT_FOOT) })
								...
								.addProperty(AttackProperty.STAMINA_DAMAGE, 40)
								.addProperty(AttackProperty.POISE_DAMAGE, 20),
				new AttackAnimation.Builder(Animations.BLACK_KNIGHT_SWORD_DA.getId(), AttackType.DASH, 0.2F, 0.0F, 0.64F,
				...
				new DeathAnimation.Builder(Animations.STRAY_DEMON_DEATH.getId(), 0.5F, DarkSouls.rl("stray_demon/death"),
