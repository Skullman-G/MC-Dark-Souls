...
public class FirstPersonRenderer extends ArmatureRenderer<LocalPlayer, LocalPlayerCap>
{
	...
	@Override
	public void render(LocalPlayer entityIn, LocalPlayerCap entityCap, EntityRenderer<LocalPlayer> renderer, MultiBufferSource buffer, PoseStack matStackIn, int packedLightIn, float partialTicks)
	{
