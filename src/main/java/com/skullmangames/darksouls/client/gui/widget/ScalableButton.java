...
public class ScalableButton extends Button
{
	...
	public void renderButton(MatrixStack matStack, int p_230431_2_, int p_230431_3_, float p_230431_4_)
	{
	    ...
	    this.blit(matStack, this.x + this.width / 2, this.y, 200 - this.width / 2, 46 + i * 20, this.width / 2, this.height / 2);
	    
	    this.blit(matStack, this.x, this.y + this.height / 2, 0, (66 + i * 20) - this.height / 2, this.width / 2, this.height / 2);
	    this.blit(matStack, this.x + this.width / 2, this.y + this.height / 2, 200 - this.width / 2, (66 + i * 20) - this.height / 2, this.width / 2, this.height / 2);
	    ...
	    if (this.height <= 10)
	    {
	    	...
	    	drawCenteredString(matStack, fontrenderer, this.getMessage(), (int)((this.x + this.width / 2) / scale), (int)((this.y + (this.height - 8) / 2) / scale), j | MathHelper.ceil(this.alpha * 255.0F) << 24);
	    	matStack.popPose();
	    }
	    else
	    {
	    	drawCenteredString(matStack, fontrenderer, this.getMessage(), this.x + this.width / 2, this.y + (this.height - 8) / 2, j | MathHelper.ceil(this.alpha * 255.0F) << 24);
	    }
	}
}
