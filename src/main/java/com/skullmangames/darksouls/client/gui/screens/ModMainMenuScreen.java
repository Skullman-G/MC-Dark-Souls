...
import com.skullmangames.darksouls.client.gui.widget.DSButton;
...
public class ModMainMenuScreen extends MainMenuScreen
{
	...
	private static final ResourceLocation DS_ACCESSIBILITY_TEXTURE = new ResourceLocation(DarkSouls.MOD_ID, "textures/guis/accessibility.png");
	private static final ResourceLocation DS_MINECRAFT_LOGO = new ResourceLocation(DarkSouls.MOD_ID, "textures/guis/title/minecraft.png");
	private static final ResourceLocation DS_MINECRAFT_EDITION = new ResourceLocation(DarkSouls.MOD_ID, "textures/guis/title/edition.png");
	...
	{
		this.addButton(new DSButton(this.width / 2 - 50, p_73969_1_, 100, 15, new TranslationTextComponent("menu.singleplayer"), (p_213089_1_) ->
		{
	    ...
	    (this.addButton(new DSButton(this.width / 2 - 50, p_73969_1_ + p_73969_2_ * 1, 100, 15, new TranslationTextComponent("menu.multiplayer"), (p_213095_1_) ->
	    {
	    ...
	    (this.addButton(new DSButton(this.width / 2 - 50, p_73969_1_ + p_73969_2_ * 2, 100, 15, new TranslationTextComponent("menu.online"), (p_238661_1_) ->
	    {
	...
	public void createDemoMenuOptions(int p_73972_1_, int p_73972_2_)
	{
	    ...
	    this.addButton(new DSButton(this.width / 2 - 50, p_73972_1_, 100, 15, new TranslationTextComponent("menu.playdemo"), (p_213091_2_) ->
	    {
	       if (flag)
	       {
	    ...
	    this.resetDemoButton = this.addButton(new DSButton(this.width / 2 - 50, p_73972_1_ + p_73972_2_ * 1, 100, 15, new TranslationTextComponent("menu.resetdemo"), (p_238658_1_) ->
	    {
	...
	protected void init()
	{
	    ...
	    if (this.minecraft.isDemo()) this.createDemoMenuOptions(j, 17);
	    else
	    {
	       this.createNormalMenuOptions(j, 17);
	       modButton = this.addButton(new DSButton(this.width / 2 - 50, j + 17 * this.buttons.size(), 100, 15, new TranslationTextComponent("fml.menu.mods"), button ->
	       {
	    ...
	    this.addButton(new DSButton(this.width / 2 - 50, j + 17 * this.buttons.size(), 100, 15, new TranslationTextComponent("menu.options"), (p_213096_1_) ->
	    {
	       this.minecraft.setScreen(new OptionsScreen(this, this.minecraft.options));
	    }));
	    this.addButton(new DSButton(this.width / 2 - 50, j + 17 * this.buttons.size(), 100, 15, new TranslationTextComponent("menu.quit"), (p_213094_1_) ->
	    {
	       this.minecraft.stop();
	    }));
	    this.addButton(new ImageButton(this.width / 2 - 124, j + 72 + 12, 20, 20, 0, 106, 20, DSButton.DS_BUTTON_LOCATION, 256, 256, (p_213090_1_) ->
	    {
	       this.minecraft.setScreen(new LanguageScreen(this, this.minecraft.options, this.minecraft.getLanguageManager()));
	    }, new TranslationTextComponent("narrator.button.language")));
	    this.addButton(new ImageButton(this.width / 2 + 104, j + 72 + 12, 20, 20, 0, 0, 20, DS_ACCESSIBILITY_TEXTURE, 32, 64, (p_213088_1_) ->
	    {
	...
	private void renderBackground()
	{
	    ...
	    bufferbuilder.vertex(0.0D, (double)this.height, 0.0D).uv(0.0F, (float)this.height / 32.0F + (float)0).color(0, 0, 0, 255).endVertex();
	    bufferbuilder.vertex((double)this.width, (double)this.height, 0.0D).uv((float)this.width / 32.0F, (float)this.height / 32.0F + (float)0).color(0, 0, 0, 255).endVertex();
	    bufferbuilder.vertex((double)this.width, 0.0D, 0.0D).uv((float)this.width / 32.0F, (float)0).color(0, 0, 0, 255).endVertex();
	...
	public void render(MatrixStack matStack, int p_230430_2_, int p_230430_3_, float p_230430_4_)
	{
		if (this.fadeInStart == 0L && this.fading) this.fadeInStart = Util.getMillis();
	      ...
	      if ((l & -67108864) != 0)
	      {
	         ...
	         net.minecraftforge.client.ForgeHooksClient.renderMainMenu(this, matStack, this.font, this.width, this.height, l);

	         String s = "Minecraft " + SharedConstants.getCurrentVersion().getName();
	         if (this.minecraft.isDemo()) s = s + " Demo";
	         else
	         {
	         ...
	         net.minecraftforge.fml.BrandingControl.forEachLine(true, true, (brdline, brd) ->
	            drawString(matStack, this.font, brd, 2, this.height - ( 10 + brdline * (this.font.lineHeight + 1)), 11184810 | l)
	         );

	         net.minecraftforge.fml.BrandingControl.forEachAboveCopyrightLine((brdline, brd) ->
	            drawString(matStack, this.font, brd, this.width - font.width(brd), this.height - (10 + (brdline + 1) * ( this.font.lineHeight + 1)), 11184810 | l)
	         );

	         drawString(matStack, this.font, "Copyright Mojang AB. Do not distribute!", this.copyrightX, this.height - 10, 11184810 | l);
	         ...
	         {
	            fill(matStack, this.copyrightX, this.height - 1, this.copyrightX + this.copyrightWidth, this.height, 11184810 | l);
	         }
