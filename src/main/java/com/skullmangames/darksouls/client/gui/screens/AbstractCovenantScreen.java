...
public abstract class AbstractCovenantScreen extends Screen
{
	...
	protected void init()
	{
		...
		this.addButton(new Button((this.width / 2) - 5 - j, this.height / 2 + 85, 10, this.buttonHeight, new StringTextComponent("<"), (b) ->
		{
	...
	public void render(MatrixStack poseStack, int mouseX, int mouseY, float partialticks)
	{
		...
		if (this.showProgress)
		{
			...
			if (reward != null)
			{
				...
				this.itemRenderer.renderAndDecorateItem(this.minecraft.player, reqItem, itemX - 25, itemY);
				this.itemRenderer.renderGuiItemDecorations(this.font, reqItem, itemX - 25, itemY);
				ItemStack rewardItem = reward.getRewardItem();
				this.itemRenderer.renderAndDecorateItem(this.minecraft.player, rewardItem, itemX + 25, itemY);
	...
	private void renderBg(MatrixStack poseStack, float partialticks, int x, int y)
	{
