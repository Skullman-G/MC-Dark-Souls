...
public class BonfireTeleportScreen extends Screen
{
	...
	{
		super(new TranslationTextComponent("gui.darksouls.teleport.title"));
	...
	protected void init()
	{
		...
		for (int i = 0; i < 7; i++)
		{
			this.buttons.add(this.addButton(new Button(x, k + (i * this.buttonHeight), this.buttonWidth, this.buttonHeight, new StringTextComponent(""), (button) ->
			{
	...
	private void renderScroller(MatrixStack poseStack, int x, int y)
	{
