...
public class DedicatedPlayerListOverride extends DedicatedPlayerList
{
	public DedicatedPlayerListOverride(DedicatedServer p_i232600_1_, Impl p_i232600_2_, PlayerData p_i232600_3_)
	{
		super(p_i232600_1_, p_i232600_2_, p_i232600_3_);
	}
